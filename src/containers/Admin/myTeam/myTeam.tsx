...
function MyTeam() {
    ...
    useEffect(() => {
        const loadClientes = async () => {
            try {
                const clientesData = await apiClient.get("/user/team");
    ...
    useEffect(() => {
        const filtered = SearchBarFilter(clientes, search, ["name", "email","roles"]);
    ...
    return (
        <div>
            <AdminHeader titulo="Minha Equipe" />
            <DivBody>
                <SearchBar 
                    value={search}
                        ...
                        <tbody>
                            {filteredClientes.map((cliente) => (
                                <TableRow key={cliente.name}>
                                    ...
                                    <TableCell>{cliente.roles}</TableCell>
                                    <TableCell>
                                        <TableActionDiv>
                                            <TableButton> 
                                                <EditOutlinedIcon 
